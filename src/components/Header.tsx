          ...
          <div className="flex flex-col">
            <a href="/" className="flex items-center">
              <span className={`text-xl md:text-2xl font-bold font-serif tracking-wide ${
                ...
                hekmat<span className={`font-serif ${isScrolled ? "text-gray-900" : "text-white"}`}>.help</span>
              </span>
            </a>
            <span className={`text-[10px] md:text-xs font-serif italic mt-1 tracking-wider ${
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a 
            ...
            className={`text-sm font-medium transition-colors ${
              isScrolled ? "text-gray-600 hover:text-gray-900" : "text-gray-50 hover:text-wisdom-200"
            }`}
          >
            Services
          </a>
